				...
				{mazeAnimDone ? (
					<>
						...
						<div className="grid grid-cols-8 gap-5 mx-auto max-w-5xl">
							...
							<section className="col-start-1 col-span-4 mt-20">
							...
							<div className="col-start-1 col-span-5">
								<div className="origin-[0%_50%] -translate-x-[9%]">
									<Image
							...
							<div className="col-start-6 col-span-3">
								...
								<div className="flex space-x-4 ">
									...
									<div className="flex flex-col">
										<Paragraph>
											Implemented secure OAuth access token flow with automatic
											refresh. Designed clean, readable, responsive layout.
											Added custom sorting algorithms.
										</Paragraph>
										<div className="flex">
											<svg
